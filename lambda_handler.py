...
def lambda_handler(event, context):
    ...
    try:
        ...
        data = {
            ...
            "first_name": body_data.get("first_name", "Unknown"),
            "last_name": body_data.get("last_name", "Unknown"),
            "phone_number": body_data.get("from_number", "Unknown"),
            "vehicle_year": body_data.get("vehicle_year", "Unknown"),
            "vehicle_model": body_data.get("vehicle_model", "Unknown"),
            "vechicle_make": body_data.get("vehicle_make", "Unknown"),
            "recording": body_data.get("recording_url", ""),
            "transcript": body_data.get("transcript", ""),
            "call_status": body_data.get("call_status", "completed"),
            "call_id": body_data.get("log_id", ""),
            "start_time": body_data.get("start_timestamp", ""),
            "end_time": body_data.get("end_timestamp", ""),
            "sentiment": body_data.get("sentiment", "Unknown"),
            "email_address": "Unknown",
            "vehicle_make": body_data.get("vehicle_make", "Unknown"),
            "appointment_date": "Unknown",
            "disposition": body_data.get("disposition_name", "Unknown"),
            "transportation_type": "Unknown",
            "callback_time": "Unknown",
            "has_multiple_accounts": "False",
            "book_appointment_error": "None",
            "campaign_id": body_data.get("campaign_id", "Unknown"),
            "dealer_id": body_data.get("dealer_id", "Unknown"),
        }
